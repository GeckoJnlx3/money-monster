...
object MonsterDataHelper {
    ...
    fun populateMonsterTable(db: SQLiteDatabase?) {
        val monsters = listOf(
            ...
            Monster(4, "gwomp", "Gwompor", R.drawable.gwomp_teen, Date(System.currentTimeMillis()), "teen", 0, 5, 2, 0, 0, "The teenage Gwomp.", false, false),
            Monster(5, "mamoo", "Moomie", R.drawable.mamoo_teen, Date(System.currentTimeMillis()), "teen", 0, 15, 2, 0, 0, "The teenage Mamoo.", false, false),
            Monster(6, "ave", "Evale", R.drawable.ave_teen, Date(System.currentTimeMillis()), "teen", 0, 25, 2, 0, 0, "The teenage Ave.", false, false),

            Monster(7, "gwomp", "Wompagwom", R.drawable.gwomp_adult, Date(System.currentTimeMillis()), "adult", 0, 5, 3, 0, 0, "The adult Gwomp.", false, false),
            Monster(8, "mamoo", "Mamoolah", R.drawable.mamoo_adult, Date(System.currentTimeMillis()), "adult", 0, 15, 3, 0, 0, "The adult Mamoo.", false, false),
